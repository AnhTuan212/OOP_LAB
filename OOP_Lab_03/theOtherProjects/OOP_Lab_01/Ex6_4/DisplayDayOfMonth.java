package OOP_Lab_03.theOtherProjects.OOP_Lab_01.Ex6_4;
...
public class DisplayDayOfMonth {
    public static void main(String[] args) {
        ...
        CalculateForDis input = new CalculateForDis(month,year);
        System.out.println("The number day of month is: "+ input.dayOfMonth());
    }
}
